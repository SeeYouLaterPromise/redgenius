  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-gray-50 p-6 rounded-lg border">
        <h3 className="text-lg font-semibold border-b pb-3 mb-4 text-gray-800">
          原文素材
        </h3>
            ...
            hotspots.map((spot) => (
              <div key={spot.id} className="flex items-center group">
                ...
                <input
                  ...
                  className="flex-1 p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-300 focus:border-red-500 transition"
                />

                {/* 为删除按钮添加onClick事件 */}
                <button
                  onClick={() => deleteHotspot(spot.id)} // <-- 添加点击事件处理
